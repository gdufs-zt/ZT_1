package cn.edu.gdufs.mall.common;
...
public class Constant {
    public static final String DS_MALL_USER = "ds_mall_user";
    public static final String SALT = "75asdawkwe*s8?.=6";
    ...
    public enum OrderStatusEnum {
        ...
        public static OrderStatusEnum codeOf(int code) {
            ...
            throw new dsMallException(dsMallExceptionEnum.NO_ENUM);
        }
