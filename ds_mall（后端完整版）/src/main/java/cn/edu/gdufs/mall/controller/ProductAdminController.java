...
import cn.edu.gdufs.mall.model.request.UpdateProductReq;
    ...
    public ApiRestResponse upload(HttpServletRequest httpServletRequest,
        ...
        if (!fileDirectory.exists()) {
            if (!fileDirectory.mkdir()) {
                throw new dsMallException(dsMallExceptionEnum.MKDIR_FAILED);
            }
        }
        try {
        ...
        try {
            ...
            return ApiRestResponse.error(dsMallExceptionEnum.UPLOAD_FAILED);
        }
    }
