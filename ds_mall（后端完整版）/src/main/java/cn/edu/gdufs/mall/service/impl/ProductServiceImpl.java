...
import cn.edu.gdufs.mall.common.Constant.ProductListOrderBy;
...
import cn.edu.gdufs.mall.model.query.ProductListQuery;
...
public class ProductServiceImpl implements ProductService {
    ...
    public void add(AddProductReq addProductReq) {
        ...
        if (count == 0) {
            throw new dsMallException(dsMallExceptionEnum.CREATE_FAILED);
        }
    }
